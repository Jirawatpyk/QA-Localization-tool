...
describe('ScoreBadge', () => {
  ...
  it('[P2] should render green/success style when score >= 95', () => {
  ...
  it('[P2] should render yellow/warning style when score is 80-94', () => {
  ...
  it('[P2] should render red/destructive style when score < 80', () => {
  ...
  it('[P2] should render gray/muted style when score is null', () => {
  ...
  it('[P2] should display score value rounded to 1 decimal place', () => {
  ...
  it('[P2] should render green at exactly 95.0', () => {
  ...
  it('[P2] should render yellow at exactly 94.9', () => {
  ...
  it('[P2] should render yellow at exactly 80.0', () => {
  ...
  it('[P2] should render red at exactly 79.9', () => {
