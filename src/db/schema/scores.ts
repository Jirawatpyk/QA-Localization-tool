import { pgTable, unique, uuid, varchar, real, integer, text, timestamp } from 'drizzle-orm/pg-core'
...
export const scores = pgTable(
  ...
  (table) => [
    // Adversarial review S1: prevent duplicate score rows from concurrent Server Action + Inngest race
