...
export const files = pgTable(
  'files',
  {
    ...
    status: varchar('status', { length: 20 }).notNull().default('uploaded'), // 'uploaded' | 'parsing' | 'parsed' | 'l1_processing' | 'l1_completed' | 'l2_processing' | 'l2_completed' | 'l3_processing' | 'l3_completed' | 'ai_partial' | 'failed'
