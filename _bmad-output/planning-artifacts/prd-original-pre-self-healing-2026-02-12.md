...
|---------|------|-----------|
| **LLM Hallucination** | AI "เห็น" error ที่ไม่มีจริง → false positive | Confidence threshold + human review; never auto-fix without confirmation |
...
| Auto-fix without confirmation | Always suggest, never auto-apply |
...
>
> **FR Count (72) vs Journey Count (63 MVP):** Journey Requirements Summary lists 63 MVP-scope items (4 Gate + 59 MVP). FRs total 72: 69 from original synthesis + 3 from Party Mode adversarial review (FR22: score lifecycle, FR23: auto-pass rationale, FR44: multi-token glossary matching). The 72 FRs are the authoritative count for implementation.
